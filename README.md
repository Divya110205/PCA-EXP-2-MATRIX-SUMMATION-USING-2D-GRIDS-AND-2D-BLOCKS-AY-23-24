...
## OUTPUT:
![Screenshot 2024-09-28 114210](https://github.com/user-attachments/assets/a96e947c-e91b-4e06-b30d-eb14c05393e2)


## RESULT:
The host took 1.011490 seconds to complete it’s computation, while the GPU outperforms the host and completes the computation in 0.128575 seconds. Therefore, float variables in the GPU will result in the best possible result. Thus, matrix summation using 2D grids and 2D blocks has been performed successfully.
